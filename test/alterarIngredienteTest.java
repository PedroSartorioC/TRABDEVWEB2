...
public class alterarIngredienteTest {
    private alterarIngrediente alterarIngrediente;
    ...
    public void setup() throws IOException {
        alterarIngrediente = new alterarIngrediente();
    ...
    public void testProcessRequestWithValidData() throws ServletException, IOException {
        ...
        String json = "{\"id\": 1, \"nome\": \"Ingredient\", \"descricao\": \"Description\", \"quantidade\": 10, " +
        ...
        alterarIngrediente.processRequest(request, response);

        writer.flush();
        String responseOutput = stringWriter.toString().trim();
        Assertions.assertEquals("Ingrediente Alterado!", responseOutput);
    }
