...
public class DaoPedido {
    ...
    public Pedido pesquisaPorData(Pedido pedido){
        ...
        String sql = "SELECT id_pedido FROM tb_pedidos WHERE tb_pedidos.id_pedido = ?";
        ...
        try{
            ...
            String userName = "";
              while (rs.next()){    
               userName = rs.getString("id_pedido");
            }
            rs.close();
            stmt.close();
            return userName;
        ...
        public String getPedidoClienteId(int id){
        String sql = "SELECT id_pedido FROM tb_pedidos WHERE tb_pedidos.id_pedido = ?";
        ...
        try{
            ...
            String userName = "";
              while (rs.next()){    
               userName = rs.getString("id_cliente");
            }
            rs.close();
            stmt.close();
            return userName;
